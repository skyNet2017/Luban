...
jpeg_simd_cpu_support JPP((void));
...
jsimd_convsamp_mmx JPP((JSAMPARRAY
sample_data,
...
jsimd_convsamp_sse2 JPP((JSAMPARRAY
sample_data,
JDIMENSION start_col,
        DCTELEM
* workspace));
...
jsimd_convsamp_neon JPP((JSAMPARRAY
sample_data,
JDIMENSION start_col,
        DCTELEM
* workspace));
...
jsimd_convsamp_float_3dnow JPP((JSAMPARRAY
sample_data,
JDIMENSION start_col,
        FAST_FLOAT
* workspace));
...
jsimd_convsamp_float_sse JPP((JSAMPARRAY
sample_data,
JDIMENSION start_col,
        FAST_FLOAT
* workspace));
...
jsimd_convsamp_float_sse2 JPP((JSAMPARRAY
sample_data,
JDIMENSION start_col,
        FAST_FLOAT
* workspace));
...
jsimd_fdct_islow_mmx JPP((DCTELEM * data));

EXTERN(void)

jsimd_fdct_ifast_mmx JPP((DCTELEM * data));

extern const int jconst_fdct_ifast_sse2[];

EXTERN(void)

jsimd_fdct_islow_sse2 JPP((DCTELEM * data));
extern const int jconst_fdct_islow_sse2[];

EXTERN(void)

jsimd_fdct_ifast_sse2 JPP((DCTELEM * data));

EXTERN(void)

jsimd_fdct_ifast_neon JPP((DCTELEM * data));

EXTERN(void)

jsimd_fdct_float_3dnow JPP((FAST_FLOAT * data));

extern const int jconst_fdct_float_sse[];

EXTERN(void)

jsimd_fdct_float_sse JPP((FAST_FLOAT * data));

/* SIMD Quantization */
EXTERN(void)

jsimd_quantize_mmx JPP((JCOEFPTR
coef_block,
DCTELEM *divisors,
        DCTELEM
* workspace));
...
jsimd_quantize_sse2 JPP((JCOEFPTR
coef_block,
DCTELEM *divisors,
        DCTELEM
* workspace));
...
jsimd_quantize_neon JPP((JCOEFPTR
coef_block,
DCTELEM *divisors,
        DCTELEM
* workspace));
...
jsimd_quantize_float_3dnow JPP((JCOEFPTR
coef_block,
FAST_FLOAT *divisors,
        FAST_FLOAT
* workspace));
...
jsimd_quantize_float_sse JPP((JCOEFPTR
coef_block,
FAST_FLOAT *divisors,
        FAST_FLOAT
* workspace));
...
jsimd_quantize_float_sse2 JPP((JCOEFPTR
coef_block,
FAST_FLOAT *divisors,
        FAST_FLOAT
* workspace));
...
jsimd_idct_2x2_mmx JPP((void * dct_table,
        JCOEFPTR
coef_block,
JSAMPARRAY output_buf,
        JDIMENSION
...
jsimd_idct_4x4_mmx JPP((void * dct_table,
        JCOEFPTR
coef_block,
JSAMPARRAY output_buf,
        JDIMENSION
...
jsimd_idct_2x2_sse2 JPP((void * dct_table,
        JCOEFPTR
coef_block,
JSAMPARRAY output_buf,
        JDIMENSION
...
jsimd_idct_4x4_sse2 JPP((void * dct_table,
        JCOEFPTR
coef_block,
JSAMPARRAY output_buf,
        JDIMENSION
...
jsimd_idct_2x2_neon JPP((void * dct_table,
        JCOEFPTR
coef_block,
JSAMPARRAY output_buf,
        JDIMENSION
...
jsimd_idct_4x4_neon JPP((void * dct_table,
        JCOEFPTR
coef_block,
JSAMPARRAY output_buf,
        JDIMENSION
...
jsimd_idct_islow_mmx JPP((void * dct_table,
        JCOEFPTR
coef_block,
JSAMPARRAY output_buf,
        JDIMENSION
...
jsimd_idct_ifast_mmx JPP((void * dct_table,
        JCOEFPTR
coef_block,
JSAMPARRAY output_buf,
        JDIMENSION
...
jsimd_idct_islow_sse2 JPP((void * dct_table,
        JCOEFPTR
coef_block,
JSAMPARRAY output_buf,
        JDIMENSION
...
jsimd_idct_ifast_sse2 JPP((void * dct_table,
        JCOEFPTR
coef_block,
JSAMPARRAY output_buf,
        JDIMENSION
...
jsimd_idct_islow_neon JPP((void * dct_table,
        JCOEFPTR
coef_block,
JSAMPARRAY output_buf,
        JDIMENSION
...
jsimd_idct_ifast_neon JPP((void * dct_table,
        JCOEFPTR
coef_block,
JSAMPARRAY output_buf,
        JDIMENSION
...
jsimd_idct_float_3dnow JPP((void * dct_table,
        JCOEFPTR
coef_block,
JSAMPARRAY output_buf,
        JDIMENSION
...
jsimd_idct_float_sse JPP((void * dct_table,
        JCOEFPTR
coef_block,
JSAMPARRAY output_buf,
        JDIMENSION
...
jsimd_idct_float_sse2 JPP((void * dct_table,
        JCOEFPTR
coef_block,
JSAMPARRAY output_buf,
        JDIMENSION
