...
jsimd_can_convsamp JPP((void));

EXTERN(int)

jsimd_can_convsamp_float JPP((void));

EXTERN(void)

jsimd_convsamp JPP((JSAMPARRAY
sample_data,
...
jsimd_convsamp_float JPP((JSAMPARRAY
sample_data,
JDIMENSION start_col,
        FAST_FLOAT
* workspace));
...
jsimd_can_fdct_islow JPP((void));

EXTERN(int)

jsimd_can_fdct_ifast JPP((void));

EXTERN(int)

jsimd_can_fdct_float JPP((void));

EXTERN(void)

jsimd_fdct_islow JPP((DCTELEM * data));

EXTERN(void)

jsimd_fdct_ifast JPP((DCTELEM * data));

EXTERN(void)

jsimd_fdct_float JPP((FAST_FLOAT * data));

EXTERN(int)

jsimd_can_quantize JPP((void));

EXTERN(int)

jsimd_can_quantize_float JPP((void));

EXTERN(void)

jsimd_quantize JPP((JCOEFPTR
coef_block,
DCTELEM *divisors,
        DCTELEM
* workspace));
...
jsimd_quantize_float JPP((JCOEFPTR
coef_block,
FAST_FLOAT *divisors,
        FAST_FLOAT
* workspace));
...
jsimd_can_idct_2x2 JPP((void));

EXTERN(int)

jsimd_can_idct_4x4 JPP((void));

EXTERN(void)

jsimd_idct_2x2 JPP((j_decompress_ptr
cinfo,
...
jsimd_idct_4x4 JPP((j_decompress_ptr
cinfo,
jpeg_component_info *compptr,
        JCOEFPTR
coef_block,
...
jsimd_can_idct_islow JPP((void));

EXTERN(int)

jsimd_can_idct_ifast JPP((void));

EXTERN(int)

jsimd_can_idct_float JPP((void));

EXTERN(void)

jsimd_idct_islow JPP((j_decompress_ptr
cinfo,
jpeg_component_info *compptr,
        JCOEFPTR
coef_block,
...
jsimd_idct_ifast JPP((j_decompress_ptr
cinfo,
jpeg_component_info *compptr,
        JCOEFPTR
coef_block,
...
jsimd_idct_float JPP((j_decompress_ptr
cinfo,
jpeg_component_info *compptr,
        JCOEFPTR
coef_block,
